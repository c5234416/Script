...
linux_to_address = "sonu.rajan@ytlcomms.my"
windows_to_address = "sonu.rajan@ytlcomms.my"
mysql_to_address = "sonu.rajan@ytlcomms.my"
additional_recipients = ["sonu.rajan@ytlcomms.my", "monalisha.mohanty@ytlcomms.my"]
subject = "PDC Alerts"
message = """
Dear Team,
